...
function ResultPTahfiz() {
  ...
  return (
    <div className="resultptahfiz-page">

      <div className="resultptahfiz-header">
        <img src={logo} alt="Logo" className="resultptahfiz-logo" />
        <h1>SURAH AL-LAIL</h1>
      </div>

      <div className="resultptahfiz-trophy">
        ...
        <p className="subtitle">Kamu telah menamatkan kuiz Tahfiz Surah Al-Lail</p>
      </div>

      <div className="resultptahfiz-scorecard">
      ...
      <div className="resultptahfiz-stats">
      ...
      <div className="resultptahfiz-msg">{grade.msg}</div>

      <button className="resultptahfiz-submit" onClick={() => window.location.href = "/gameptahfiz"}>
        Cuba Semula
      </button>

      <button className="resultptahfiz-back" onClick={() => window.location.href = "/tahfiz/pertengahan"}>
        ← Kembali ke Menu
      </button>

      <div className="resultptahfiz-nav">
