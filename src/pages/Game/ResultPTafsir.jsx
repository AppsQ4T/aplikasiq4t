...
function ResultPTafsir() {
  ...
  return (
    <div className="resultptafsir-page">

      <div className="resultptafsir-header">
        <img src={logo} alt="Logo" className="resultptafsir-logo" />
        <h1>SURAH AL-LAIL</h1>
      </div>

      <div className="resultptafsir-trophy">
        ...
        <p className="subtitle">Kamu telah menamatkan kuiz Tafsir Surah Al-Lail</p>
      </div>

      <div className="resultptafsir-scorecard">
      ...
      <div className="resultptafsir-stats">
      ...
      <div className="resultptafsir-msg">{grade.msg}</div>

      <button className="resultptafsir-submit" onClick={() => window.location.href = "/gameptafsir"}>
        Cuba Semula
      </button>

      <button className="resultptafsir-back" onClick={() => window.location.href = "/tafsir/pertengahan"}>
        ← Kembali ke Menu
      </button>

      <div className="resultptafsir-nav">
