...
function ResultLTahfiz() {
  ...
  return (
    <div className="resultltahfiz-page">

      <div className="resultltahfiz-header">
        <img src={logo} alt="Logo" className="resultltahfiz-logo" />
        <h1>SURAH YASIN</h1>
      </div>

      <div className="resultltahfiz-trophy">
        ...
        <p className="subtitle">Kamu telah menamatkan kuiz Tahfiz Surah Yasin</p>
      </div>

      <div className="resultltahfiz-scorecard">
      ...
      <div className="resultltahfiz-stats">
      ...
      <div className="resultltahfiz-msg">{grade.msg}</div>

      <button className="resultltahfiz-submit" onClick={() => window.location.href = "/gameltahfiz"}>
        Cuba Semula
      </button>

      <button className="resultltahfiz-back" onClick={() => window.location.href = "/tahfiz/lanjutan"}>
        ← Kembali ke Menu
      </button>

      <div className="resultltahfiz-nav">
